...
const LinkVaretoFooter = () => {
    return (
        <footer className="bg-background-secondary border-t border-border-divider">
            <div className="container py-16">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
                    ...
                    <div className="md:col-span-1">
                        ...
                        <p className="text-text-secondary mb-4">
                            The modern way to plan, model, and collaborate on your financial future.
                        </p>
                    ...
                    {/* Product */}
                    <div>
                        <h4 className="text-lg font-semibold text-text-primary mb-4">Product</h4>
                ...
                <div className="border-t border-border-divider pt-8 flex flex-col md:flex-row justify-between items-center">
...
export default LinkVaretoFooter;

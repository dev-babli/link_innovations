...
const LinkVaretoMultiplayerEditingSection = () => {
    return (
            ...
            <div className="container">
                ...
                <div className="mt-12 md:mt-16">
                    <Image
                        ...
                        alt="An example of record level planning in Link Innovations"
                        width={2240}
                        height={1292}
...
export default LinkVaretoMultiplayerEditingSection;

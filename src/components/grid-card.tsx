...
function getRandomPattern(length?: number): [x: number, y: number][] {
	...
	const patterns = [
		[[8, 2], [9, 3], [7, 4], [10, 1], [8, 5]],
		[[7, 2], [9, 4], [8, 3], [10, 2], [7, 5]],
		[[9, 1], [8, 4], [10, 3], [7, 2], [9, 5]],
		[[8, 3], [7, 1], [9, 2], [8, 4], [10, 5]],
		[[10, 2], [8, 5], [7, 3], [9, 1], [8, 4]]
	];
	return patterns[0].slice(0, length) as [x: number, y: number][];
}

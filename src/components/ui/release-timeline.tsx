...
export const defaultEntries: TimeLine_01Entry[] = [
  {
    ...
    description:
      "Link Innovations now ships with an advanced component pack including complex layouts, enterprise-ready data tables, and animated navigation menus.",
    items: [
  ...
  },
  {
    ...
    description:
      "We've introduced a fully customizable theme builder powered by design tokens so you can tailor Link Innovations to match any brand identity.",
    items: [
  ...
  },
  {
    ...
    description:
      "Micro-interactions across Link Innovations have been enhanced with Framer Motion, delivering a smoother and more engaging user experience.",
    items: [
  ...
  },
  {
    ...
    description:
      "Link Innovations Pro is here — a premium set of components, templates, and utilities designed for production-grade applications.",
    items: [
    ...
    button: {
      url: "/contact",
      text: "View Link Innovations Pro",
    },
  },
];
...
export default function TimeLine_01({
  title = "Link Innovations Release Notes",
  description = "Stay up to date with the latest components, features, and performance enhancements in Link Innovations — built to help you design and ship faster.",

...
const DEFAULT_GLOW_COLOR = '26, 26, 26';
...
const cardData: BentoCardProps[] = [
  ...
  },
  {
    ...
    description: 'Scalable cloud infrastructure and deployment solutions for reliability and security',
    label: 'Cloud'
  },
  {
    color: '#ffffff',
    title: 'Cybersecurity',
    description: 'Comprehensive security solutions to protect your data, systems, and infrastructure',
    label: 'Security'
  }
];

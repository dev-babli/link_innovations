...
export const Logos = () => {
  const topRowCompanies = [
    {
      name: "Mercury",
      logo: "/mainline_service_template/logos/mercury.svg",
      width: 143,
      height: 26,
    ...
    {
      name: "Watershed",
      logo: "/mainline_service_template/logos/watershed.svg",
      width: 154,
      height: 31,
    ...
    {
      name: "Retool",
      logo: "/mainline_service_template/logos/retool.svg",
      width: 113,
      height: 22,
    ...
    {
      name: "Descript",
      logo: "/mainline_service_template/logos/descript.svg",
      width: 112,
      height: 27,
  ...
  const bottomRowCompanies = [
    {
      name: "Perplexity",
      logo: "/mainline_service_template/logos/perplexity.svg",
      width: 141,
      height: 32,
    ...
    {
      name: "Monzo",
      logo: "/mainline_service_template/logos/monzo.svg",
      width: 104,
      height: 18,
    ...
    {
      name: "Ramp",
      logo: "/mainline_service_template/logos/ramp.svg",
      width: 105,
      height: 28,
      href: "https://ramp.com",
    },
    {
      name: "Raycast",
      logo: "/mainline_service_template/logos/raycast.svg",
      width: 128,
      height: 33,
    ...
    {
      name: "Arc",
      logo: "/mainline_service_template/logos/arc.svg",
      width: 90,
      height: 28,
      href: "https://arc.com",
    },
      ...
      <div className="container space-y-10 lg:space-y-16">
        <div className="text-center">
          <h2 className="mb-4 text-xl text-balance md:text-2xl lg:text-3xl">
            Trusted by teams shipping with Link Innovation.
            <br className="max-md:hidden" />
            <span className="text-muted-foreground">
              From venture-backed scale-ups to global enterprises.
            </span>
          </h2>
        </div>

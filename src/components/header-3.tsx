			...
			<nav className="mx-auto flex h-24 w-full max-w-5xl items-center justify-between px-4">
				<div className="flex items-center gap-5">
					...
					<NavigationMenu className="hidden md:flex">
						<NavigationMenuList>
							<NavigationMenuItem>
								<NavigationMenuTrigger className="bg-transparent text-black">Services</NavigationMenuTrigger>
							...
							<NavigationMenuItem>
								<NavigationMenuTrigger className="bg-transparent text-black">Company</NavigationMenuTrigger>

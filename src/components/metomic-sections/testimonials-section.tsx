...
const testimonials: Testimonial[] = [
  {
    id: 'kantox',
    company: 'Kantox',
    quote: 'Easy integration. It is as simple as a few clicks (and the Metomic onboarding process is excellent, too, as the team guides us through the process).',
  ...
  },
  {
    id: 'wrapbook',
    company: 'Wrapbook',
    quote: 'Metomic provides an excellent, easy-to-navigate interface with the necessary features to help keep our workspace secure.',
  ...
  },
  {
    id: 'numan',
    company: 'Numan',
    quote: 'Metomic is user-centric, easy to use and has some great integrations. The best thing is that it helps data controllers remain compliant but more importantly able to easily assess risks and prevent breaches or infringements.',
  ...
  },
  {
    id: 'zappi',
    company: 'Zappi',
    quote: 'Immediately, especially for the Google Workspace document sharing, Metomic has paid for itself seven fold.',
...
const metomicLogoUrl = 'https://slelguoygbfzlpylpxfs.supabase.co/storage/v1/object/public/test-clones/eaef4bf1-d07d-48c3-b176-750b9be61de7-metomic-io/assets/icons/6672ecf19cd586d2e16a0c71_Frame%2010194-38.jpeg?';

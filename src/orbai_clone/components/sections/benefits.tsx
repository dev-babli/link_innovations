      ...
      <div className="container mx-auto px-6 sm:px-8 lg:px-20 py-24 sm:py-32">
        ...
        >
          ...
          <p className="text-lg text-secondary-text max-w-lg">
            Partner with an IT agency delivering innovative digital solutions.
          </p>
        </motion.div>
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          >
            ...
            <div className="relative z-10 flex flex-col gap-2">
              <h3 className="text-xl font-medium text-primary-text">Innovation-First</h3>
          ...
          >
            ...
            <div className="relative z-10 flex flex-col gap-2 mt-auto">
              <h3 className="text-xl font-medium text-primary-text">Scalable Solutions</h3>
              <p className="text-base text-secondary-text leading-relaxed">
          ...
          >
            ...
            <div className="relative z-10 flex flex-col gap-2">
              <h3 className="text-xl font-medium text-primary-text">Security-Focused</h3>
              <p className="text-base text-secondary-text leading-relaxed">
